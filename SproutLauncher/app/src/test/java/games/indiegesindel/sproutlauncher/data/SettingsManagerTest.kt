...
class SettingsManagerTest {
    ...
    fun default_values_loaded_from_prefs_or_defaults() = runTest(UnconfinedTestDispatcher()) {
        ...
        assertThat(settings.horizontalSpacing.first()).isEqualTo(8)
        assertThat(settings.verticalSpacing.first()).isEqualTo(8)
        assertThat(settings.appTileRoundness.first()).isEqualTo(16)
